      ...
      <Container>
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-3 max-w-xs text-sm leading-relaxed text-on-ink-muted">
          ...
          {COLUMNS.map((col) => (
            <div key={col.heading}>
              <h4 className="text-xs font-medium uppercase tracking-[0.16em] text-on-ink-muted">
                {col.heading}
              </h4>
        ...
        <div className="mt-14 flex flex-col gap-4 border-t border-ink-line pt-8 text-xs text-on-ink-muted sm:flex-row sm:items-center sm:justify-between">
