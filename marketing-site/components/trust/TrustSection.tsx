...
export function TrustSection() {
  return (
    <section id="trust" className="relative bg-ink py-28 md:py-36">
      <Container>
        <div className="grid items-center gap-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8">
          ...
          >
            ...
            <p className="max-w-lg text-base leading-relaxed text-on-ink-muted md:text-lg">
            ...
            <dl className="mt-4 flex flex-col gap-6 border-t border-ink-line pt-8">
              {PILLARS.map((pillar, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <dd className="mt-1.5 text-sm leading-relaxed text-on-ink-muted">
                      {pillar.body}
                    </dd>
                  </div>
                </motion.div>
          ...
          >
            <BadgeMoment />
            <p className="mt-6 text-center text-xs uppercase tracking-[0.18em] text-on-ink-muted/70">
