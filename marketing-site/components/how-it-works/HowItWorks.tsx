...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="relative bg-ink pb-28 pt-4 md:pb-36">
      <Container>
        <SectionHeading
        ...
        <div className="mt-4 grid gap-8 border-t border-ink-line pt-12 md:grid-cols-3 md:gap-10">
          {STEPS.map((step, i) => (
            <motion.div
              key={step.n}
            ...
            >
              ...
              <p className="text-sm leading-relaxed text-on-ink-muted md:text-base">
                {step.body}
              </p>
            </motion.div>
          ))}
